package scenes
{
    ...
    public class TextureScene extends Scene
    {
        public function TextureScene()
        {
            ...
            var image1:Image = new Image(StartUp.assets.getTexture("flight_00"));
            image1.x = -20;
            image1.y = 0;
            addChild(image1);
            
            var image2:Image = new Image(StartUp.assets.getTexture("flight_04"));
            image2.x = 90;
            image2.y = 85;
            addChild(image2);
            
            var image3:Image = new Image(StartUp.assets.getTexture("flight_08"));
            image3.x = 100;
            image3.y = -60;
            addChild(image3);
            ...
            try
            {
                ...
                var compressedTexture:Texture = StartUp.assets.getTexture("compressed_texture");
